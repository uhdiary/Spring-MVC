...
function validate(){
	...
	else if(!chk(/^([1][0-9]|2[0-2])$/, classtime)){
	...
	else if(document.getElementById("SB_INTRODUCE").value.length > 20){
...
<div style="height: 70px;"></div>
	<h2>학생 등록</h2>
	<HR>
	<form action="studentinsert.do" method="POST" enctype="multipart/form-data" onsubmit="return validate();">
		<input type="hidden" id="SB_USERID" name="SB_USERID" value="${userid}"/>
			<div id="enrolldiv">			
				...
				<p>
						...
						<span style="height:10px;">&nbsp;</span>
						<input type="submit" class = "button1" value="등록"> <br/><br/>
			</div>	
