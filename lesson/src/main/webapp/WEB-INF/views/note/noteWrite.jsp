...
<div id="nav_wrap">
	...
	<div id="notee">
		<ul id="tabs">
			<li><a href="#" name="#tab3">쪽지 쓰기</a></li>
		</ul>
		<div id="content">
		<div id="tab3">
			<form action="noteWrite.do" method="post" enctype="multipart/form-data">
				<input type="submit" class="myButton" value="보내기">
				<input type="hidden" value="${loginUser.userid }" name="loginid">
				<input type="hidden" value="${loginUser.userid }" name="sendid">
				<br><br>
				<label for="receiveid" style="font-size:10pt">&nbsp;&nbsp;&nbsp;&nbsp;받는 사람</label>
				&nbsp;&nbsp;&nbsp;&nbsp;<input type="search" id="receiveid" name="receiveid" cols="50"><br>
				<textarea style="resize: none; outline: none;" cols="80" rows="10" name="notect"></textarea>
